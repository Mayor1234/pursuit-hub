    ...
    <div className="flex flex-col w-full">
      ...
      {showButton && (
        <button
          ...
          disabled={false}
          className="bg-pry text-[#080808] py-3 mt-10 w-32 border-[1px] border-solid border-transparent text-sm rounded-md self-center lg:w-40 lg:text-base  active:bg-tertiary transition-all delay-75 duration-300 ease-in-out"
        >
